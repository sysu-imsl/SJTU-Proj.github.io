$().ready(function() {
   ...
   $("a[href*=_ueditor\\/dialogs\\/showOriginalImg\\.html\\?img\\=]").each(function(i) {
       ...
       //"showOriginalImg.html-img=-_upload-article-46-75-e99fc72945928ad0cf21f744c3cb-9ee2ff3c-b98a-4623-afb7-757e8a266205_d.png        $(.htm"/*tpa=http://miv.cumt.edu.cn/_ueditor/dialogs/showOriginalImg.html?img=/_upload/article/46/75/e99fc72945928ad0cf21f744c3cb/9ee2ff3c-b98a-4623-afb7-757e8a266205_d.png        $(*/img[src*=_upload\\/article\\/]", this).each(function(i) {
    ...
    q.event = function() {
        ...
        if(isSupportTouch){
        	...
        	if(typeof touch === "undefined"){
                layer.use("touch.min.js"/*tpa=http://miv.cumt.edu.cn/_js/_portletPlugs/wp_photos/layer/extend/extend/touch.min.js*/,function(){
                    q.touch();
                });
            }else{
                q.touch();
...
layer.use("layer.ext.css"/*tpa=http://miv.cumt.edu.cn/_js/_portletPlugs/wp_photos/layer/extend/skin/layer.ext.css*/,
function() {
    layer.ext && layer.ext()
});